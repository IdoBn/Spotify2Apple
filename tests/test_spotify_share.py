...
@pytest.fixture
def spotify_api() -> lib.SpotifyAPI:
    return lib.SpotifyAPI(
...
def test_spotify_to_apple_episode(spotify_api):
...
def test_spotify_to_apple_moshe(spotify_api):
